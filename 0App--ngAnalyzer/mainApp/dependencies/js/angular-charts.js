...
angular.module('angularCharts').directive('acChart', [
   ...
   */
     ...
     */
       ...
       * @type {[type]}
       */
        var svg = d3.select(chartContainer[0]).append('svg').attr('width', (width+100) + margin.left + margin.right).attr('height', height + margin.top + margin.bottom).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
